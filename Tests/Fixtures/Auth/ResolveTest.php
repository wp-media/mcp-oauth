...
return ( static function (): array {
	$url = 'https://example.com/cimd.json';

	$encode = static function ( array $data ): string {
		return json_encode( $data ); // phpcs:ignore WordPress.WP.AlternativeFunctions.json_encode_json_encode -- fixture data loads before WP is bootstrapped; wp_json_encode() is unavailable at this point.
	};
